...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice teamwork and soccer skills with the school team",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "maria@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Improve swimming technique and compete in friendly meets",
    ...
    "Debate Team": {
        "description": "Practice public speaking and critical thinking with debate competitions",
